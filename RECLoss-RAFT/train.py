...
def main(args):
    ...
    if torch.cuda.is_available():
        model = nn.DataParallel(RAFT(args), device_ids=args.device_ids)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt', default=r"119999_sintel.pth")
    ...
    parser.add_argument('--point_nums', help='how many points to compute fmatrix: default**2' ,default=30)
